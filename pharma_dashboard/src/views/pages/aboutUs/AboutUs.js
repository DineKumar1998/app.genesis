...
import { isAddress, isDescription, isEmail, isPhonenumber } from "src/lib/validator";
...
class AboutUs extends React.Component {
  ...
  async componentDidMount() {
    ...
    if (rs.success === true && rs.data !== null) {
      const { id, about, address, address2, address3, phone, whatsapp, whatsapp_greeting, website,
        email, twitter, facebook, pinterest, linkedin, corporate_video } = rs.data;

      this.setState({
        id, about, address, address2, address3, phone, whatsapp, whatsapp_greeting, website,
