...
const Distributor = React.lazy(() => import('./views/pages/distributor/Distributor'))
...
const Category = React.lazy(() => import('./views/pages/product/category/Category'))
const Division = React.lazy(() => import('./views/pages/product/division/Division'))
const PackingType = React.lazy(() => import('./views/pages/product/packingType/PackingType'))

const Orders = React.lazy(() => import('./views/pages/orders/Orders'))
const Customer = React.lazy(() => import('./views/pages/customer/Customer'))
const Notification = React.lazy(() => import('./views/pages/notification/Notification'))
const Gallery = React.lazy(() => import('./views/pages/gallery/Gallery'))
const Offer = React.lazy(() => import('./views/pages/offer/Offer'))
const Promotional = React.lazy(() => import('./views/pages/promotional/Promotional'))
...
const routes = [
  ...
  { path: '/distributor', exact: true, name: 'Distributor', component: Distributor },
