...
exports.ProductFormatter = (product) => {
    ...
    return {
        ...
        new_launched: product.new_launched,
...
const downloadLinksFormatter = (links, divisions) => {
    ...
    // let res = links.map(it=>{
    //     return {
    //         division_id: it.division_id._id,
    //         division_name: it.division_id.name,
    //         product_list_link: it.product_list_link,
    //         visualaids_link: it.visualaids_link
    //     }
    // });
    return response;
}
